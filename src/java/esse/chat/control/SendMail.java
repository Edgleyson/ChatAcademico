...
public class SendMail {
    ...
    public void sendMail(String from, String to, String subject, String message) {  
        ...
        auth = new SimpleAuth ("essechat.academico@gmail.com","esseesse");  
...
//        Session session = Session.getDefaultInstance(props, auth);  
        ...
        try {  
            ...
            msg.setContent(message,"text/plain");//text/html;charset=UTF-8 
        ...
        try {  
             ...
             */  
            tr.connect(mailSMTPServer, "essechat.academico@gmail.com", "esseesse");  
