...
public interface ChatterDao {
    ...
    Chatter pesquisarDados(Long id)throws SQLException;
    Chatter consultarPeloEmail(String email) throws SQLException;
    Chatter consultarPeloNickname(String nickname) throws SQLException;
